  ...
  <>
    ...
    <Parallax pages={5}>
      <Hero offset={0}>
        ...
        <Subtitle> I'm Derek, and this is a stab at an alternate portfolio page.  Enjoy my insanity in web format<br /> <em> &copy; Like A Fox Development </em> </Subtitle>
      </Hero>
      <Projects offset={1}>
        <Title>Projects</Title>
        <ProjectsWrapper>
          {tileData.map((tile,i) => <ProjectCard title={tile.title} bg={`url(${tile.background})`} link={tile.pathname} >{tile.subtitle}</ProjectCard>)}
        </ProjectsWrapper>
      </Projects>
      <About offset={3}>
        <Title>About</Title>
      ...
      <Contact offset={4}>
        ...
        <Footer>
          ...
          <a href="https://github.com/like-a-fxx/parallax-fox">Github Repository</a>. Made by{' '}
